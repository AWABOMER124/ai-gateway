...
# DATABASE_URL uses the internal container-network hostname (awab-ai-postgres),
# resolvable only from inside containers. This script runs on the bare host,
# where the same database is reachable at 127.0.0.1:5438.
