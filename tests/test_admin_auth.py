...
def test_accepts_same_origin_browser_mutation():
    assert is_same_origin_browser_request(
        "https://ai-gateway.perfect-team.cloud",
        "ai-gateway.perfect-team.cloud",
    )


def test_rejects_cross_origin_or_missing_origin():
    assert not is_same_origin_browser_request(
        "https://attacker.example",
        "ai-gateway.perfect-team.cloud",
    )
    assert not is_same_origin_browser_request("", "ai-gateway.perfect-team.cloud")
